    ...
    <div className="min-h-screen bg-[#0F1A24] relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <main className="max-w-3xl mx-auto px-6 md:px-12 py-12 md:py-20">
          ...
          <p
            className="text-lg md:text-2xl text-[#FAF9F7] font-light italic leading-relaxed mb-10 max-w-2xl"
            style={{ fontFamily: "var(--font-cormorant-garamond), serif" }}
          >
            The loop runs whether you watch it or not. Most weeks look like last week. LANE is the
            inquiry that makes the loop visible enough to choose, this week, what to repeat and
            what to change.
          </p>

          <div className="space-y-4 text-[#B8B5A8] font-light leading-relaxed mb-8 max-w-2xl">
            <p>
              Four sections. Lookback, Anchor, Next, Envision. About twenty-five questions across
              the four. You answer the ones that catch you, not every one every week.
            </p>
            <p>
