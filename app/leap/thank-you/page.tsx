...
export default function LeapThankYou() {
  return (
    <div className="min-h-screen bg-[#0F1A24] flex flex-col">
      <div className="flex-1 flex flex-col items-center justify-center px-6 py-12">
        <div className="max-w-lg w-full text-center">
          ...
          <p
            ...
            style={{ fontFamily: "Cormorant Garamond, serif" }}
          >
            The 5-Minute Founder&apos;s Reset. Use it before a high-stakes meeting, at the start of your day, or whenever you need to come back to center.
          </p>
      ...
      {/* Cross-promote the guide — dark with gold accent */}
      <div className="w-full bg-[#1A2A3A] border-t-2 border-[#C9A227] py-14 px-6">
        <div className="max-w-lg mx-auto text-center">
          <h2
            ...
            style={{ fontFamily: "Cormorant Garamond, serif" }}
          >
            Curious if your company could go public?
          </h2>
          <p
            className="text-white/70 text-base mb-6 leading-relaxed"
            style={{ fontFamily: "Cormorant Garamond, serif" }}
          >
            The real listing requirements, what it costs, and two structuring strategies most founders have never heard of. Free PDF guide.
          </p>
          <a
            href="/guide"
