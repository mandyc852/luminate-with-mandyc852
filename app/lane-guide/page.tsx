...
const whatsInsideItems = [
  {
    title: "LOOKBACK",
    description: "Audit the week behind you. What worked. What didn’t. What you avoided. The data your calendar can’t show you.",
  },
  {
    title: "ANCHOR",
    description: "Name what you’re standing on this week. The non-negotiables, not the wishlist. The line nothing else gets to cross.",
  },
  {
    title: "NEXT",
    description: "Pick the one move that compounds. Not the busiest one. The most consequential one. Everything else gets demoted.",
  },
  {
    title: "ENVISION",
    description: "See the version of this business that already exists six months out. Reverse-engineer the week from there.",
  },
]
...
const ABOUT_PARAGRAPH_2_SUFFIX =
  ", I share the practice underneath the work: how leaders who get through capital events intact actually run their own operating system underneath the engagement."
      ...
      <div className="flex flex-1 min-h-0">
        ...
        >
          <div className="max-w-lg w-full">
            ...
            >
              For founders running on more than instinct.
            </p>
            ...
            <p
              ...
              style={{ fontFamily: "var(--font-cormorant-garamond), serif" }}
            >
              LANE is a 45-minute weekly inquiry. Four prompts. Pen and paper. The operating system underneath the engagements that I run for myself — now in your hands.
            </p>
            ...
            <form onSubmit={onSubmit} className="space-y-3 mb-3">
              ...
              {success && (
                <p className="text-center text-[#1A2A3A] font-medium text-sm" style={{ fontFamily: "var(--font-cormorant-garamond), serif" }}>
                  Check your email — the LANE framework is on its way.
                </p>
              )}
              <button
                type="submit"
              ...
              >
                {isSubmitting ? "Sending…" : "GET THE LANE FRAMEWORK"}
              </button>
            </form>
...
export default function LaneGuidePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setFirstName("")
      setEmail("")
      const redirectUrl = data.redirect || "/lane/thank-you"
      setTimeout(() => {
